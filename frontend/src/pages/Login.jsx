...
export default function Login() {
 ...
 <h1
  className="text-red-600 text-4xl lg:text-5xl  font-extrabold tracking-widest"
  style={{
    fontFamily: `Netflix Sans", "Helvetica Neue", "Segoe UI", Roboto, Ubuntu`,
  
  }}
>
  CINEFLIX
</h1>
    <span className="text-gray-400 text-[10px] md:text-xs tracking-wider -mt-1">
      ...
      <div className="relative min-h-screen w-full inset-0 bg-[url('https://wallpapers.com/images/hd/netflix-background-gs7hjuwvv2g0e9fj.jpg?utm_source=chatgpt.com')]
...
mb-12 px-6 md:px-20 lg:ml-80">
      ...
      ${errors.password ? "border-red-600" : "border-gray-600"}`}
        ...
        <div className="lg:py-10 lg:mt-20 bg-[#313030] text-[#BABABA] lg:text-md">
        <footer className="relative z-20 w-full text-sm px-6 pt-10 md:pt-14  md:text-left">
            <p className=" lg:text-lg ">Questions? Call 000-800-919-1694 (Toll-Free)</p>

            <div className=" text-[#BABABA] grid grid-cols-2 md:grid-cols-4 gap-3 mt-5 mb-4">
